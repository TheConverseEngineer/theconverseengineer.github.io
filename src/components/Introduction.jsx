...
export const Introduction = () => {
    ...
    <div className="mx-[5%] h-full flex flex-col gap-4 max-w-xl items-center">
        ...
        <div className="flex justify-center gap-4">
            ...
            <a target="_blank" href={CONTENT.github_link} rel="noopener noreferrer" className="bg-background border-1 border-accent h-7 w-7 flex justify-center items-center rounded-full text-accent hover:text-background hover:bg-accent">
                <IoLogoGithub size="20"/>
            </a>
            <a target="_blank" href={CONTENT.linkedin_link} rel="noopener noreferrer" className="bg-background border-1 border-accent h-7 w-7 flex justify-center items-center rounded-full text-accent hover:text-background hover:bg-accent">
